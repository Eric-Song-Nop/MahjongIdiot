...
def run_jianyang_ai(drawer=None):
    ...
    user = "ID249403E8-3bUcGFAP"  # the user ID that you got after having registered in tenhou.net
    user_name = "test_ma"  # the user name that you have created while registration in tenhou.net
...
def run_my_ai(drawer=None):
    # the OBJECT of your own implemented Mahjong agent
    ai_module = importlib.import_module("agents.my_ai")
    ai_class = getattr(ai_module, "MyAI")
    ai_obj = ai_class()
    ...
    logger_obj = Logger("my_log1", user_name)      # two arguments: id of your test epoch, user name
